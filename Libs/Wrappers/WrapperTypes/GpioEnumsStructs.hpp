...
namespace WrapperBase {
	...
	/*
	 * @brief Énumération des résultats possibles de l'initialisation d'une broche GPIO.
	 *		Ok : Initialisation réussie
	 *		ClockError : Erreur d'activation de l'horloge du port GPIO
	 *		HalError : Erreur lors de l'appel de la fonction d'initialisation du HAL
	 *		NoHandleAvailable : Aucun handle disponible pour l'initialisation de la broche GPIO
	**/
